	...
	public function index()
	{
        if(is_null(session()->get('logged_in'))){
            ...
            if(session()->get('role') == 'admin') {
                $dataPeminjaman = $db->query("SELECT a.id_peminjaman, a.id_permintaan, a.id_dialihkan, a.tgl_diterima, a.tgl_dialihkan, a.tgl_dikembalikan, b.jumlah, b.status, c.id_barang, c.nama_barang, d.id_users, d.nama FROM peminjaman a, permintaan b, barang c, users d WHERE a.id_permintaan = b.id_permintaan AND b.id_barang = c.id_barang AND b.id_users = d.id_users ORDER BY a.id_peminjaman DESC")->getResult('array');
            } else {
                $dataPeminjaman = $db->query("SELECT a.id_peminjaman, a.id_permintaan, a.id_dialihkan, a.tgl_diterima, a.tgl_dialihkan, a.tgl_dikembalikan, b.jumlah, b.status, c.id_barang, c.nama_barang, d.id_users, d.nama FROM peminjaman a, permintaan b, barang c, users d WHERE a.id_permintaan = b.id_permintaan AND b.id_barang = c.id_barang AND b.id_users = d.id_users AND b.id_users = $id_users ORDER BY a.id_peminjaman DESC")->getResult('array');
            }
